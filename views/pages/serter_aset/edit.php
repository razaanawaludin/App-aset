<?php
    ...
    PageHeader(
        "Serah Terima Aset",
        $isSelesai ? "Dokumen serah terima telah selesai" : "Edit dokumen serah terima aset",
                        ...
                        <form method="POST" action="$formAction" autocomplete="off">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="position-relative">
                                    <input type="text" name="no_surat" value="$noSurat_val" class="form-control form-control-lg bg-light border-0 fs-6 ps-5" style="border-radius: 10px;" readonly>
...
<?php
    ...
    $printNoSurat = htmlspecialchars($noSurat_val);
...
<!-- tolong benahi edit di halaman serah terima seperrtinya tertukar dengan detail, tolong cek kembali -->