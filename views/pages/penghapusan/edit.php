                    ...
                    <form method="POST" autocomplete="off">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="pegawai" class="form-select form-select-lg bg-light border-0 fs-6 text-dark" name="id_pegawai" style="cursor: pointer;">
                                ...
                                <option value="4">Razzarorr (RA)</option>
                            </select>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex gap-2">
                                <select name="id_pegawai" class="form-select form-select-lg bg-light border-0 fs-6 text-dark" style="cursor: pointer;">
                                    ...
                                    <option value="1">BRG-001 - Monitor MacBook Office</option>
                                ...
                                <tr>
                                    <td class="ps-4 py-3">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <span class="text-muted small">KODE: BRG-001</span>
                                                <h6 class="mb-0 fw-bold text-dark" style="font-size: 0.95rem;">Monitor MacBook Office</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td>Komputer</td>
