<?php
    PageHeader(
       ...
       buttonhref("?pg=$pg&fl=user","Kembali","primary","circle-chevron-left",$attbr="")
    );
    ...
    if($ak == "tambah"){
        $passwordFieldHTML = <<<html
            <input type="password" class="form-control form-control-lg bg-light border-0 fs-6" placeholder="Masukan Password" style="border-radius: 10px;" required name="pwd">
html;
    } else {
        $passwordFieldHTML = <<<html
            <div class="input-group">
                <input type="password" id="inputPassword" class="form-control form-control-lg bg-light border-0 fs-6" placeholder="Kosongkan jika tidak diubah" style="border-radius: 10px 0 0 10px;" name="pwd">
            ...
            <form method="POST"> 
                <div class="row g-4 mb-4">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="username" class="form-control form-control-lg bg-light border-0 fs-6" placeholder="Razzarorr" style="border-radius: 10px;" required>
                    </div>
